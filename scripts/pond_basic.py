...
class ServerDaemon:
    #pid_dir = os.getenv("POND_ROOT")+"/pids"
    pid_dir = pond_root+"/pids"
    def __init__(self,run_func,pidfile='pond.pid',name='pond',stdin='/dev/null',stdout='/dev/null',stderr='/dev/null'):
        self.stdin = stdin
        self.stdout  = stdout
        self.stderr = stderr
