...
enum MatrixOperationsType {
    MatrixOperations_FFT_FORWARD,
    MatrixOperations_FFT_BACKWARD
};
class MatrixOperationsModule : public Module {
   ...
   public:
    ...
    ~MatrixOperationsModule();
    /***************************************************/
    int PD_multiThreadsTest(Object&);
    /***************************************************/
    void Init();
    ...
    static void FFT(
        ...
        MatrixOperationsType direction = MatrixOperations_FFT_FORWARD);
    static void FFT(
        int rank,
        int n[],
