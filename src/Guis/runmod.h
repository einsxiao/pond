#ifndef Runmod_GuisModule_POND_H
#define Runmod_GuisModule_POND_H
...
public:
  ...
  QPlainTextEdit  *edit;
  pond::Object   obj;
  FieldType(int,QPlainTextEdit*,pond::Object );
};
...
private:
  ...
  void LoadInput(string,pond::Object&input);
  bool Object2TextParts(pond::Object&,string[3],FieldType*ft);
  void FlushUI();
  void UpdateInput(pond::Object intput);
