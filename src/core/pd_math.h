...
///////////////////////////////////////////
__cond_host_device__ inline double _pow2(double x) {
    return x * x;
}
__cond_host_device__ inline double _pow3(double x) {
    return x * x * x;
}
__cond_host_device__ inline double _pow4(double x) {
    double pow2 = _pow2(x);
    return pow2 * pow2;
}
__cond_host_device__ inline double _pow5(double x) {
    return _pow4(x) * x;
}
__cond_host_device__ inline double _pow6(double x) {
    return _pow5(x) * x;
}
__cond_host_device__ inline double _pow7(double x) {
    return _pow6(x) * x;
}
__cond_host_device__ inline double _pow8(double x) {
    double pow4 = _pow4(x);
    return pow4 * pow4;
}
__cond_host_device__ inline double _pow9(double x) {
    return _pow8(x) * x;
}
__cond_host_device__ inline double _pow10(double x) {
    return _pow8(x) * _pow2(x);
}
__cond_host_device__ inline double _pow11(double x) {
    return _pow8(x) * _pow3(x);
}
__cond_host_device__ inline double _pow12(double x) {
    double pow4 = _pow4(x);
    return pow4 * pow4 * pow4;
}
__cond_host_device__ inline double _pow13(double x) {
    return _pow12(x) * x;
}
__cond_host_device__ inline double _pow14(double x) {
    return _pow12(x) * _pow2(x);
}
__cond_host_device__ inline double _pow15(double x) {
    return _pow12(x) * _pow3(x);
}
__cond_host_device__ inline double _pow16(double x) {
    double pow8 = _pow8(x);
    return pow8 * pow8;
}
...
struct floatcomplex {
   public:
    ...
    __cond_host_device__ explicit inline operator float() const { return re; };
    __cond_host_device__ explicit inline operator double() const { return re; };
    ...
    __cond_host_device__ inline bool realq() const { return im == 0; }
    ...
    __cond_host_device__ inline friend floatcomplex operator/(
        ...
        return floatcomplex((c1.re * c2.re + c1.im * c2.im) / mo,
                            (c1.im * c2.re - c1.re * c2.im) / mo);
    }
    __cond_host_device__ inline friend floatcomplex operator/(
        const floatcomplex c1,
        const float c2) {
    ...
    // overload ^
    // overload != ==
    __cond_host_device__ inline friend int operator!=(const floatcomplex c1,
                                                      const floatcomplex c2) {
...
struct complex {
   public:
    ...
    __cond_host_device__ inline friend complex operator/(const complex c1,
        ...
        return complex((c1.re * c2.re + c1.im * c2.im) / mo,
                       (c1.im * c2.re - c1.re * c2.im) / mo);
    }
    __cond_host_device__ inline friend complex operator/(const complex c1,
                                                         const double c2) {
    ...
    // overload ^
    // overload != ==
    __cond_host_device__ inline friend int operator!=(const complex c1,
                                                      const complex c2) {
        if (c1.re != c2.re || c1.im != c2.im)
            return 1;
        else
...
struct Index {
    ...
    inline bool zeroQ() const {
        return *(reinterpret_cast<const double*>(this)) == 0;
    }
    inline bool nonzeroQ() const {
        return *(reinterpret_cast<const double*>(this)) != 0;
    }
    inline void zero() { *(reinterpret_cast<double*>(this)) = 0; }
    /* inline void set(double val){ *(reinterpret_cast<double*>(this)) = val; };
     */
    inline void set(u_int r, u_int c) {
        row = r;
        col = c;
    };
#define _deal(oper)                                                          \
    inline friend bool operator oper(const Index& ind1, const Index& ind2) { \
        return *reinterpret_cast<const double*>(&ind1) oper *                \
               reinterpret_cast<const double*>(&ind2);                       \
    }
    _deal(==);
    _deal(!=);
#undef _deal
