...
ClassModule::ClassModule():Module(MODULE_NAME){
...
int ClassModule::PD_class(Object&argv){
  CheckShouldEqual( 2 );
...
int ClassModule::PD_CLASS$DEFINED$(Object&Argv){ // A($$_i_j,A)
...
int ClassModule::PD_CLASS$INSTANCE$(Object&Argv){
...
// int ClassModule::PD_test(Object&Argv){ //, "通用函数定义"
...
// int ClassModule::PD_test2(Object&arg){
